...
import com.epam.serdyukov.ispmanager.model.dao.TariffQueryBuilder;
...
public class UserRepoImpl implements IUserRepo {
    private static final String GET_ALL = "SELECT id, login, password, role_id, user_details_id, is_blocked FROM users";
    private static final String GET_BY_ID = "SELECT id, login, password, role_id, user_details_id, is_blocked FROM users WHERE id = ?";
    private static final String GET_BY_LOGIN = "SELECT id, login, password, role_id, user_details_id, is_blocked FROM users WHERE login = ?";
    private static final String CREATE = "INSERT INTO users (login, password, role_id, user_details_id, is_blocked) VALUES (?, ?, ?, ?, ?)";
    private static final String UPDATE = "UPDATE users SET login = ?, password = ?, role_id = ?, user_details_id=?, is_blocked=? WHERE id = ?";
